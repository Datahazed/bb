...
// Clickable sidebar rows show a pointer cursor by default. Draggable rows
// (threads in the Folders view) override this with cursor-grab.
...
// folder rows. Text color only — no row-level hover highlight or pointer.
...
export const SIDEBAR_ROW_SELECTED_STATE_CLASS =
  "cursor-pointer bg-sidebar-border/70 text-sidebar-foreground";
