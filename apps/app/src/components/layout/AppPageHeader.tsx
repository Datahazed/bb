...
/**
 * Close visible-edge spacing between the active thread-title surface and its
 * adjacent Spotlight control. The surfaces remain distinct while proximity
 * keeps the control associated with the title.
 */
