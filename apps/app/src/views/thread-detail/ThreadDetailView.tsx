...
import { ThreadPresenceHeaderAvatars } from "@/components/thread/presence/ThreadPresenceIndicators";
...
function ThreadDetailViewInternal(props: ThreadDetailViewInternalProps) {
  ...
  const timelineHeader = (
    <ThreadDetailHeader
      ...
      presenceIndicator={<ThreadPresenceHeaderAvatars threadId={thread.id} />}
