/**
 * Test fakes for the dispatch-handler suites, ported verbatim from
 * `apps/host-daemon/test/command/dispatch-helpers.ts` (P1c).
 */
...
import type { CommandDispatchOptions } from "../core/command-dispatch-support.js";
