/**
 * Ported from `apps/host-daemon/src/codex-chatgpt-client.test.ts` (P1a engine
 * scaffold; the daemon copy dies in P1c). `fetch` is mocked as a true external
 * boundary (chatgpt.com / api.openai.com); auth fixtures live in a temp HOME.
 */
