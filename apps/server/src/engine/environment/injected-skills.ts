/**
 * Ported near-verbatim from `apps/host-daemon/src/injected-skills.ts`
 * (P1a engine scaffold; the daemon copy dies in P1c): content-addressed
 * staging of injected skill sources under
 * `<dataDir>/runtime/global-skills/<catalogHash>`, plus cleanup of stages no
 * live runtime references. The only adaptation is reusing the engine-wide
 * `isFsErrorWithCode` (`../core/fs-errors.js`) instead of a private
 * re-declaration.
 */
