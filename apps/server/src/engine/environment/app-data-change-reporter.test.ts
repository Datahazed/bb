...
describe("AppDataChangeReporter", () => {
  ...
  it("re-primes tracked applications and posts resync hints after target replacement", async () => {
  ...
  it("posts resync hints for apps whose data disappeared between replacements", async () => {
