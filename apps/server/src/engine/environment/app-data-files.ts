/**
 * Ported near-verbatim from `apps/host-daemon/src/app-data-files.ts`
 * (P1a engine scaffold; the daemon copy dies in P1c): confined reads and
 * listings of installed-app data files under the merged dataDir's
 * `apps/` + `app-data/` roots. Only the support-module import paths changed.
 */
...
import { NON_IMAGE_FILE_SIZE_LIMIT_BYTES } from "../handlers/file-read.js";
import { resolveNonSymlinkDirectoryPath } from "../handlers/root-path.js";
