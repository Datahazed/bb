...
import { refreshDueEnvironmentStatusSnapshots } from "../environments/environment-status-snapshots.js";
...
const PERIODIC_SWEEP_JOBS: PeriodicSweepJob[] = [
  ...
  },
  {
    ...
    run: (deps, now) => refreshDueEnvironmentStatusSnapshots(deps, now),
  },
  {
