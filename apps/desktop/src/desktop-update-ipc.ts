...
export const BB_DESKTOP_INSTALL_UPDATE_WHEN_IDLE_CHANNEL =
  "bb-desktop:install-update-when-idle";
export const BB_DESKTOP_CANCEL_DEFERRED_INSTALL_CHANNEL =
  "bb-desktop:cancel-deferred-install";
