...
only go down, and CI rejects added diff lines containing a provider-id reference
even when the same change removes an older occurrence. When you only remove
