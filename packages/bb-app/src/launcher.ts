...
Startup-only server and launcher keys:
  ...
  BB_EXPO_PUSH_URL, BB_EXTERNAL_URL, BB_HOST_DAEMON_PORT, BB_INFERENCE,
  BB_INFERENCE_FALLBACK, BB_INHERITED_SKILLS_ROOTS, BB_LOG_LEVEL,
  BB_MANAGED_DEV_BUILTIN_PLUGIN_HOT_RELOAD, BB_POSTHOG_API_KEY,
  BB_PUSH_NOTIFICATIONS, BB_SERVER_BIND_HOST, BB_SERVER_PORT,
  BB_TELEMETRY, BB_TRANSCRIPTION, and BB_FF_* feature flags.
