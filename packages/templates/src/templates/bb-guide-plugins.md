...
added/updated/unchanged counts.
  ...
  bb plugin install <entry>      Install a bundled official plugin by name
                                 (github, github-notifications, docs, memory,
...
BB's official plugins — GitHub, GitHub Activity, Docs, Memory, and Tasks — ship
...
(`bb plugin install github`, `bb plugin install github-notifications`,
...
builtins and the store-only BB Official GitHub, GitHub Activity, Docs, Memory,
and Tasks plugins. The `examples/plugins/` reference plugins cover slack-bot (webhook
