...
// Custom section glyphs. Hugeicons has no matching outlined-row icons, so they
// live here in the same element format as the set. The add variant preserves
// the explicit plus-bearing action glyph used on main while the identity glyph
// remains plus-free.
