...
declare const experimentsSchema: z$1.ZodRecord<
  z$1.ZodEnum<{
...
declare const hostDaemonCommandRegistry: {
  "thread.rewind.discard": HostDaemonCommandDescriptor<
    ...
    false
  >;
  "thread.rewind.prepare": HostDaemonCommandDescriptor<
  ...
  "provider.usage": HostDaemonCommandDescriptor<
    ...
    true
  >;
  "workspace.discover_repos": HostDaemonCommandDescriptor<
 ...
 */
declare const pluginCatalogResolvedSourceSchema: z$1.ZodDiscriminatedUnion<
  [
    z$1.ZodObject<
      {
 ...
 */
declare const pluginCatalogInstallPlanSchema: z$1.ZodDiscriminatedUnion<
  [
    z$1.ZodObject<
      {
    ...
    z$1.ZodObject<
      {
        ...
        >;
        source: z$1.ZodString;
        resolvedSource: z$1.ZodDiscriminatedUnion<
          [
            z$1.ZodObject<
              {
                kind: z$1.ZodLiteral<"npm">;
 ...
 * or account emails.
 */
declare const onboardingTelemetryEventSchema: z$1.ZodDiscriminatedUnion<
  [
    z$1.ZodObject<
      {
...
declare const continueAfterProviderRateLimitRequestSchema: z$1.ZodObject<
  ...
  z$1.core.$strict
>;
type ContinueAfterProviderRateLimitRequest = z$1.infer<
...
type ThreadContinueAfterRateLimitResult =
