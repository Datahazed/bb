...
@supports ((background-clip: text) or (-webkit-background-clip: text)) {
  .bb-thread-hover-card__summary[data-working="true"]
    ...
    background: linear-gradient(
      105deg,
      color-mix(in oklab, var(--foreground) 84%, transparent) 0%,
      color-mix(in oklab, var(--foreground) 84%, transparent) 40%,
      var(--foreground) 50%,
      color-mix(in oklab, var(--foreground) 84%, transparent) 60%,
      color-mix(in oklab, var(--foreground) 84%, transparent) 100%
    );
